magn = sqrt(2)/2;
s = [[1,-1]; [1.5, 0.5]; [-1,0]; [-1, -1.5]; [0,1.25]];
fs = [0.15, 0.1, 0.25, 0.4, 0.1];

rng(0,'twister');
a = -2;
b = 2;
y1 = (b-a).*rand(10000,1) + a;
y2 = (b-a).*rand(10000,1) + a;
y = [y1 y2];
...
title("Map Decision Boundaries for No=1")
hold off;
